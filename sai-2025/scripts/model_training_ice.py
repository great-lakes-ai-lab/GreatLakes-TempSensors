...
data_processor = DataProcessor(os.path.join(deepsensor_folder))
...
cache_tasks_to_disk(
    train_dates,
    outdir= SCRATCH_DIR + "training2/train_tasks",
    N=250,
...
cache_tasks_to_disk(
    val_dates,
    outdir= SCRATCH_DIR + "training2/val_tasks",
    N=250,
    lakemask_raw=lakemask_raw,
    data_processor=data_processor,
)
